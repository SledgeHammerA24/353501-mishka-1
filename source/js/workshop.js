...
var button_writeus = document.querySelector(".contacts_btn"); // переменной button_writeus присваиваем первый элемент с классом
...
var popup_overlay = document.querySelector(".modal_overlay"); // переменной popup_overlay присваиваем первый элемент с классом .modal_overlay - то бишь это сетка-блокировка под попапом
var cross_close = document.querySelector(".modal_content_close"); // переменной cross_close присваиваем первый элемент с классом .modal_content_close - то бишь это крестик, закрывающий окошко попапа
